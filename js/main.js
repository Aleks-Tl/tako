...
/* harmony import */ var _node_modules_countup_js_dist_countUp_min_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../node_modules/countup.js/dist/countUp.min.js */ "./node_modules/countup.js/dist/countUp.min.js");
...
/* harmony import */ var _node_modules_choices_js_public_assets_scripts_choices_min_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../node_modules/choices.js/public/assets/scripts/choices.min.js */ "./node_modules/choices.js/public/assets/scripts/choices.min.js");
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  menuButtons.forEach(btn => {
    btn.addEventListener('click', e => {
      ...
      let currentDropdown = currentButton.closest('.menu__item').querySelector('[data-js-dropdown-menu]');
      menuButtons.forEach(btn => {
...
// Transformation button of contact

new transfer_elements__WEBPACK_IMPORTED_MODULE_3__["default"]({
  sourceElement: document.querySelector('.header__contact'),
  breakpoints: {
    1023.98: {
      targetElement: document.querySelector('.menu__mobile-contacts'),
      targetPosition: 1
    }
  }
});
...
if (document.querySelectorAll('.numbers').length > 0) {
  let countUpArr = new Array();
  function countUpFunction(id, finalNum) {
    ...
    countUpArr.push(new _node_modules_countup_js_dist_countUp_min_js__WEBPACK_IMPORTED_MODULE_4__.CountUp(id, finalNum, mergeOptions));
  }
  countUpFunction('count-up-ware', 10043);
  countUpFunction('count-up-production', 432100);
  countUpFunction('count-up-donat', 173213);
  countUpFunction('count-up-thread', 713);
  countUpFunction('count-up-parcel', 90000);
  countUpFunction('count-up-work', 8760);
}

// Slider for section how we work

if (document.querySelectorAll('.work').length > 0) {
  const swiper = new swiper__WEBPACK_IMPORTED_MODULE_5__["default"]('.work__slider', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_6__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_6__.Scrollbar, swiper_modules__WEBPACK_IMPORTED_MODULE_6__.EffectFade],
    effect: "fade",
    navigation: {
      nextEl: ".swiper-button-next",
      prevEl: ".swiper-button-prev"
...
if (document.querySelectorAll('.testimonials').length > 0) {
  const swiper = new swiper__WEBPACK_IMPORTED_MODULE_5__["default"]('.testimonials__slider', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_6__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_6__.Scrollbar],
    loop: true,
    slidesPerView: 4,
    spaceBetween: 32,
    navigation: {
...
if (document.querySelectorAll('.checkout').length > 0) {
  ...
  const selectDeliveryCity = document.querySelector('#deliveryCity');
  const selectDeliveryBranch = document.querySelector('#deliveryBranch');
  const choicesDeliveryCity = new _node_modules_choices_js_public_assets_scripts_choices_min_js__WEBPACK_IMPORTED_MODULE_7__(selectDeliveryCity, {
    searchEnabled: true,
    itemSelectText: ''
  });
  const choicesDeliveryBranch = new _node_modules_choices_js_public_assets_scripts_choices_min_js__WEBPACK_IMPORTED_MODULE_7__(selectDeliveryBranch, {
    placeholder: true,
    searchEnabled: false,
    itemSelectText: '',
    shouldSort: false
  ...
  steppers.forEach(steppersEl => {
    const stepperInput = steppersEl.querySelector('.stepper__input');
    const stepperBtnUp = steppersEl.querySelector('.stepper__btn-up');
    const stepperBtnDown = steppersEl.querySelector('.stepper__btn-down');
